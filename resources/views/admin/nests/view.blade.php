...
<div class="row">
            ...
            <div class="box">
                <div class="box-body">
                    <div class="form-group">
                        <label class="control-label">{{ __("admin.name") }} <span class="field-required"></span></label>
                        <div>
    ...
    <div class="col-md-6">
        <div class="box">
            <div class="box-body">
                <div class="form-group">
                    <label class="control-label">{{ __("admin.nest_id") }}</label>
                    <div>
                ...
                <div class="form-group">
                    <label class="control-label">{{ __("admin.uuid") }}</label>
                    <div>
    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">{{ __("admin.nest_eggs") }}</h3>
            </div>
            ...
            <div class="box-footer">
                <a href="{{ route('admin.nests.egg.new') }}"><button class="btn btn-success btn-sm pull-right">{{ __("admin.new_egg") }}</button></a>
            </div>
        </div>
    </div>
</div>
